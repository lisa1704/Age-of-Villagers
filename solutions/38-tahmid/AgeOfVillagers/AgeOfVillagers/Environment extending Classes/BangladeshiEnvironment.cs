...
namespace AgeOfVillagers.Environment_extending_Classes
{
    public class BangladeshiEnvironment : Environment
    {
        ...
        public BangladeshiEnvironment(Label nation_Name, RadioButton firstNation ,RadioButton secondNation, RadioButton thirdNation, RadioButton fourthNation, RadioButton tree, RadioButton house, RadioButton waterSource, Graphics graphics, string selectedNation,Color color)
        {
