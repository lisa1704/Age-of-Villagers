...
namespace AgeOfVillagers.Environment_extending_Classes
{
    class EgyptianEnvironment : Environment
    {
        ...
        public EgyptianEnvironment(Label nation_Name, RadioButton seconNation1, RadioButton thirdNation, RadioButton fourthNation, RadioButton tree, RadioButton house, RadioButton waterSource, Graphics graphics, RadioButton seconNation2)
        {
