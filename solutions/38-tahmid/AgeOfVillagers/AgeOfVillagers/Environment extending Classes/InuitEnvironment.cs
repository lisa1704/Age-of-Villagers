...
namespace AgeOfVillagers.Environment_extending_Classes
{
    class InuitEnvironment : Environment
    {
        ...
        public InuitEnvironment(Label nation_Name, RadioButton seconNation1, RadioButton thirdNation, RadioButton fourthNation, RadioButton tree, RadioButton house, RadioButton waterSource, Graphics graphics, RadioButton seconNation2)
        {
