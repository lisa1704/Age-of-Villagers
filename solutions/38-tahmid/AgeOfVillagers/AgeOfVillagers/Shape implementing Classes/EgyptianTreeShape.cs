...
namespace AgeOfVillagers.Shape_implementing_Classes
{
    class EgyptianTreeShape : Shapes
    {
        ...
        public void makeShape()
        {
            ...
            root = drawableShapeFactory.GetDrawableShape(graphics, pen, startingPoint, rootRightPoint, rootLeftPoint, Constants.VSHAPE_HINT);
            root.makeShape();
            ...
            rightBranch = drawableShapeFactory.GetDrawableShape(graphics, pen, rootRightPoint, righttBranchRightPoint, rightBranchLeftPoint, Constants.VSHAPE_HINT);
            rightBranch.makeShape();   
            
            rightMidBranch = drawableShapeFactory.GetDrawableShape(graphics, pen,  rootRightPoint, righttBranchMidPoint, Constants.LINE_HINT);
            ...
            leftBranch = drawableShapeFactory.GetDrawableShape(graphics, pen, rootLeftPoint, leftBranchRightPoint, leftBranchLeftPoint, Constants.VSHAPE_HINT);
            leftBranch.makeShape();

            leftMidBranch = drawableShapeFactory.GetDrawableShape(graphics, pen, rootLeftPoint, leftBranchMidPoint, Constants.LINE_HINT);
