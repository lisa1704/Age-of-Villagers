                ...
                new EventHandler<MouseEvent>() {
                    ...
                    public void handle(MouseEvent event) {
                        if (flag) {
                            ...
                            new Line_Shape(top, left, graphicsContext);
                            new Line_Shape(left, down, graphicsContext);
                            new Line_Shape(down, right, graphicsContext);
                            new Line_Shape(right, top, graphicsContext);
                            new Line_Shape(top, down, graphicsContext);
                        }
                    }
                });
    }
