        ...
        canvas.addEventHandler(MouseEvent.MOUSE_PRESSED, new EventHandler<MouseEvent>(){
            ...
            public void handle(MouseEvent event) {
                if (flag) {
                    ...
                    new Line_Shape(new Point(main_point.x, main_point.y),new Point(main_point.x + 3 , main_point.y - 6 ),graphicsContext).draw();
                    new Line_Shape(new Point(main_point.x, main_point.y),new Point(main_point.x - 3, main_point.y -6 ),graphicsContext).draw();
                    new Line_Shape(new Point(main_point.x + 3 , main_point.y - 6 ),new Point(left_mid.x + 4, left_mid.y - 4 ),graphicsContext).draw();
                    new Line_Shape(new Point(main_point.x + 3 , main_point.y - 6 ),new Point(left_mid.x + 2, left_mid.y - 4 ),graphicsContext).draw();
                    new Line_Shape(new Point(main_point.x + 3 , main_point.y - 6 ),new Point(left_mid.x - 3, left_mid.y - 4 ),graphicsContext).draw();
                    new Line_Shape(new Point(main_point.x - 3, main_point.y -6 ),new Point(right_mid.x + 2, right_mid.y - 4  ),graphicsContext).draw();
                    new Line_Shape(new Point(main_point.x - 3, main_point.y -6 ),new Point(right_mid.x - 2, right_mid.y - 4 ),graphicsContext).draw();
                    new Line_Shape(new Point(main_point.x - 3, main_point.y -6 ),new Point(right_mid.x  - 4, right_mid.y - 4 ),graphicsContext).draw();
                }
            }
        });
    }
