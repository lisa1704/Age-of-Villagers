...
namespace AgeOfVillagers.Test
{
    public class Bangladeshiobjecttesting
    {
        ...
        {
            IObject actual = nationfactory.GetNation("Bangladeshi Farmers").Draw_house(lptop);
        ...
        {
            IObject actual = nationfactory.GetNation("Bangladeshi Farmers").Draw_tree(lptop);
        ...
        {
            IObject actual = nationfactory.GetNation("Bangladeshi Farmers").Draw_watersource(lptop);
